...
ax1.bar(x - width/2, df["Stimmenanteile AfD"], width, color="#009EE0", label="Stimmenanteile AfD")
ax1.set_xticks(x)
...
ax2 = ax1.twinx()
ax2.bar(x + width/2, df["Baulandpreise"], width, color="#FFC422", label="Baulandpreise")
...
plt.title("Simmenanteile AfD  vs Baulandpreise", fontsize=26)
